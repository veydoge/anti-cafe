...
fun ReservationConfirmationPage(roomsViewModel: RoomsViewModel, gamesViewModel: GamesViewModel, authViewModel: AuthViewModel, onNavigateMain: () -> Unit){
    ...
    Column{
        ...
        Column(modifier = Modifier
            ...
            Button(onClick = {
                roomsViewModel.makeReservation(Reservation(roomsViewModel.selectedRoom!!.id, authViewModel.userAuthInfo!!.id, roomsViewModel.selectedTime!!, roomsViewModel.hoursSelected!!))
                onNavigateMain()
